      ...
      <section className="mx-auto max-w-6xl px-4 py-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Validate mapping rules and ensure ledger grouping is correct.
            </p>
            <button
              ...
              onClick={() => router.push("/team-lead/review-mapping")}
            >
              Open Mapping
            </button>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Forward approved datasets to Manager for final approval.
            </p>
            <button
              className="mt-4 w-full rounded-xl border border-slate-200 bg-white py-2.5 text-sm font-medium text-slate-800
                         hover:bg-slate-50 active:bg-slate-100 transition
                         focus:outline-none focus:ring-4 focus:ring-slate-200"
              onClick={() => router.push("/team-lead/send-to-manager")}
            >
              Send Now
            </button>
          </div>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <ul className="mt-4 space-y-3 text-sm">
            {[
              "Review mapping and ledger group consistency",
              "Approve or reject imported files with comments",
              "Send approved dataset to Manager",
            ].map((item) => (
